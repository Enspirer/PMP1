            ...
            <main class="page-content">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <div class="container">
                            <div class="row border rounded py-5 align-items-center card-db">
                    ...
                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        <div class="container">
                                                ...
                                                <h6 class="accordion-header" id="panelsStayOpen-headingOne">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-1 p-0 text-right">
                                                            <i class="fas fa-pen rounded-pill text-muted" style="background-color:#e3dfde; padding:13px;"></i>
                                                        </div>
                                                        <div class="col-1 p-0 text-right">
                            ...
                            <div class="mt-5">
                                <div class="row justify-content-between">
                                    <div class="col-5">
                                        <h4 class="d-inline-block mr-3">Company Size</h4> <i class="fas fa-pen rounded-pill text-muted ml-3" style="background-color:#e3dfde; padding:13px;"></i>
                                    </div>
                                </div>
                                ...
                                <div class="row border rounded py-3 card-db mt-4 align-items-center">
                                    <div class="col-11">
                                        <p class="mb-0">50+ employees &nbsp;&nbsp;&nbsp;&nbsp; (medium size)</p>
                                    </div>
                                    <div class="col-1">
                                        <i class="fas fa-pen rounded-pill text-muted ml-3" style="background-color:#e3dfde; padding:13px;"></i>
                                    </div>
                            ...
                            <div class="mt-5">
                                <div class="row justify-content-between">
                                    <div class="col-5">
                                        <h4 class="d-inline-block mr-3">Skill set</h4> <i class="fas fa-pen rounded-pill text-muted ml-3" style="background-color:#e3dfde; padding:13px;"></i>
                                    </div>
                                </div>
                            ...
                            <div class="mt-5">
                                <div class="row justify-content-between">
                                    <div class="col-5">
                                        <h4 class="d-inline-block mr-3">License and Certifications</h4> <i class="fas fa-plus rounded-pill text-muted ml-3" style="background-color:#e3dfde; padding:13px;"></i>
                                    </div>
                                </div>
                                        ...
                                        <div class="accordion" id="accordionPanelsStayOpenExample">
                                            <div class="accordion-item">
                                                <h6 class="accordion-header" id="panelsStayOpen-headingFour">
                                                    <div class="row align-items-center">
                                                        <div class="col-10 p-0">
                                                            <h6 class="mb-0">Verified by google 360</h6>
                                                        </div>
                                                        <div class="col-1 p-0 text-right">
                                                            <i class="fas fa-pen rounded-pill text-muted" style="background-color:#e3dfde; padding:13px;"></i>
                                                        </div>
                            ...
                            <div class="mt-5">
                                <div class="row justify-content-between">
                                    <div class="col-5">
                                        <h4 class="d-inline-block mr-3">Awards and Badges</h4> <i class="fas fa-plus rounded-pill text-muted ml-3" style="background-color:#e3dfde; padding:13px;"></i>
                                    </div>
                                </div>
                                ...
                                <div class="row border rounded py-3 card-db mt-4 mb-3">
                                    <div class="col-12">
                                        <div class="accordion" id="accordionPanelsStayOpenExample">
                                            <div class="accordion-item">
                                                <h6 class="accordion-header" id="panelsStayOpen-headingFive">
                                                    <div class="row align-items-center">
                                                        <div class="col-10 p-0">
                                                            <h6 class="mb-0">Best web design award 2021</h6>
                                                        </div>
                                                        <div class="col-1 p-0 text-right">
                                                            <i class="fas fa-pen rounded-pill text-muted" style="background-color:#e3dfde; padding:13px;"></i>
                                                        </div>
                            ...
                            <div class="mt-5">
                                <div class="row justify-content-between">
                                    <div class="col-5">
                                        <h4 class="d-inline-block mr-3">Other Experties</h4> <i class="fas fa-plus rounded-pill text-muted ml-3" style="background-color:#e3dfde; padding:13px;"></i>
                                    </div>
                                </div>
                                        ...
                                        <div class="accordion" id="accordionPanelsStayOpenExample">
                                            <div class="accordion-item">
                                                <h6 class="accordion-header" id="panelsStayOpen-headingSix">
                                                    <div class="row align-items-center">
                                                        <div class="col-10 p-0">
                                                            <h6 class="mb-0">Web SEO planning publication 2021</h6>
                                                        </div>
                                                        <div class="col-1 p-0 text-right">
                                                            <i class="fas fa-pen rounded-pill text-muted" style="background-color:#e3dfde; padding:13px;"></i>
                                                        </div>
