<!-- profile_info -->
  <div class="modal fade" id="portfolio_view" tabindex="-1" aria-labelledby="portfolio_view_Label" aria-hidden="true">
    <div class="modal-dialog" style="max-width: 60%;">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="portfolio_view_Label"></h5>
        ...
        <div class="modal-footer">
          <a href="" type="button" class="btn text-light" style="background-color: #FF6347;">View more</a>
