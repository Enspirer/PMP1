<div class="container">
    ...
    <div class="row border rounded py-3 align-items-center card-db text-center">
        <div class="col">
            <div class="pie" data-pie='{ "percent": 100, "round": true, "number": false, "colorCircle": "#e6e6e6", "size": "160", "lineargradient": ["#0e9031","#00ff22"] }' ></div>

            <h6 class="font-weight-bold mt-4">100% Response Rate</h6>
        </div>
        ...
        <div class="col">
            <div class="pie" data-pie='{ "percent": 96, "round": true, "number": false, "colorCircle": "#e6e6e6", "size": "160", "lineargradient": ["#0e9031","#00ff22"] }'></div>

            <h6 class="font-weight-bold mt-4">96% Order Completion</h6>
        </div>

        <div class="col">
            <div class="pie" data-pie='{ "percent": 90, "round": true, "number": false, "colorCircle": "#e6e6e6", "size": "160", "lineargradient": ["#0e9031","#00ff22"] }'></div>

            <h6 class="font-weight-bold mt-4">90% On-Time Delivery</h6>
        </div>

        <div class="col">
            <div class="pie" data-pie='{ "percent": 97, "round": true, "number": false, "colorCircle": "#e6e6e6", "size": "160", "lineargradient": ["#0e9031","#00ff22"] }'></div>
