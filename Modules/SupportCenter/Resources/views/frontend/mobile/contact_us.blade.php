...
<section id="mobile-contact-hero">
      ...
      <div class="row m-0">
        ...
        <div class="col-6 p-2">
          <div class="bg-gray">
            ...
            <h1 class="mt-3">Accounts</h1>
            <p>accounts@tallantor.com</p>
          </div>
        </div>
    ...
    <section id="partner-office-mob">
        ...
        <div class="swiper-container swiper-container-mob5 mt-5">
                ...
                <div class="card-contact">
                    ...
                    <div class="content-part">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10 col-10">No - 512
                                Al Zahra Building
                                Al Nabaa
                                Sharjah
                                UAE
              ...
              <div class="swiper-slide">
                <div class="card-contact">
                    ...
                    <div class="content-part">
                        ...
                        <div class="row">
                            <div class="col-md-2 col-1"><i class="fa fa-map-marker" aria-hidden="true"></i></div>
                            <div class="col-md-10 col-10">Unit 134 Lomeshaye Business Village,
                                Turner road,
                                Nelson,
                                Lancashire, BB9 7DR
                                United Kiingdom
                  ...
                  <div class="swiper-slide">   <div class="card-contact">
                    <div class="map-part-top">
                        <img class="map" src="{{url('theme_light/assets/map.png')}}" alt="">
                    ...
                    <div class="content-part">
                        ...
                        <div class="row">
                            <div class="col-md-2 col-1"><i class="fa fa-map-marker" aria-hidden="true"></i></div>
                            <div class="col-md-10 col-10">192 1/1 Rajamaha Vihara Road,
                                Kotte 10100,
                                Sri Lanka
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2 col-1"><i class="fa fa-phone" aria-hidden="true"></i></div>
                            <div class="col-md-10 col-10">+94 777009990</div>
                        </div>
                  ...
                  <div class="swiper-slide"> <div class="card-contact">
                    ...
                    <div class="content-part">
                        ...
                        <div class="row">
                            <div class="col-md-2 col-1"><i class="fa fa-map-marker" aria-hidden="true"></i></div>
                            <div class="col-md-10 col-10">A 15-03 Tropicana Avenue, NO.12 Persiaran Tropicana,
